...
export default function LoginPage() {
  ...
  return (
    <div className="relative isolate bg-gray-900 h-screen w-full flex items-center justify-center">
        ...
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg/8 text-gray-300">
              Entrez votre adresse e-mail et votre mot de passe pour accéder à votre espace sécurisé.
            </p>
            <p className="mt-6 text-sm text-gray-300">
              Pas encore inscrit ?{" "}
              <a href="/register" className="mt-6 text-sm text-gray-300 underline ml-0 hover:ml-2 transition-all duration-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 pt-20 pb-24 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            {(serverError.includes("Email") ||
              ...
              <p className="text-red-500 text-sm pt-2">{serverError}</p>
            )}
